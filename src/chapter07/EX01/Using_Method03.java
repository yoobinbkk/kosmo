...
public class Using_Method03 {
	...
	// 인스턴스 메소드 : 객체화해야 사용 가능
	void abc () {						// main 메소드에서 선언하면 안 됨
	...
	// Static 메소드 내부에 인스턴스 필드나, 메소드를 바로 사용할 수 없다. (객체화시켜야 사용 가능)
		// 

	public static void main(String[] args) {
		
		// main 메소드도 method이다.
		int a;							// 지역 변수이다. <-- Stack에 저장, 강제 초기화가 안 됨
		...
		*/
		...
		// 필드명, 메소드명 앞에 static 키가 적용되어 있으면 객체 생성 없이 호출할 수 있음.
