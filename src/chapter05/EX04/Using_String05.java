...
public class Using_String05 {
	...
	public static void main(String[] args) {
		...
		//		3. 객체 자체를 출력할 때 객체의 주소가 출력되는 것이 아니라 객체의 값이 출력 (toString() 메소드가 재정의 되어 있다.)
		//		4. 다양한 메소드가 정의되어 있다.
		...
		System.out.println(str2.length());			// 13자	<-- byte가 아닌 글자수
		...
		// 없는 내용을 검색 시
		System.out.println(str1.indexOf("bye"));					// -1 (존재하지 않음)
		
		System.out.println(str2.indexOf("반갑습니다"));					// 7
		System.out.println(str1.indexOf("고맙습니다"));					// -1
