...
public class Using_Scanner {
	...
	public static void main(String[] args) {
		...
		/* Scanner : 첫 글자가 대문자로 시작 : 클래스 (객체를 생성하는 틀)
				...
				- Scanner import한 경우에 반드시 sc.close();를 해주어야 한다.
		*/
		
		Scanner sc = new Scanner (System.in);
			// Scanner 클래스로부터 sc라는 객체를 생성함. (sc : 콘솔을 통해서 인풋을 받음)
		...
		System.out.println("변수 b를 출력0 : " + b);
		
		System.out.println("반드시 실수 값을 입력하세요>>>");
